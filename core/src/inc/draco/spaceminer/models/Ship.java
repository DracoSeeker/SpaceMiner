...
public class Ship extends Sprite {
    ...
    public float speed = 1f; //Speed in as percentage of max
    public float turn = 1f; //Turning rate as proportion of max
    public float boost = 3f; //Speed boost
...
//            pos.add((float) (-Math.cos(Math.toRadians(getRotation() - 90)) * speed * delta), (float) (-Math.sin(Math.toRadians(getRotation() - 90)) * speed * delta), 0);
            ...
            if (Gdx.input.isKeyPressed(Input.Keys.SHIFT_LEFT)) force.setLength(force.len() * boost);
